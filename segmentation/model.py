...
from hmamba import Backbone_VSSM
#from vmamba_hcurve_hilbert_zigzag import Backbone_VSSM
...
#selective_scan_flop_jit: Callable = build.vmamba_hcurve_hilbert_seg.selective_scan_flop_jit

from models.hmamba import selective_scan_flop_jit
supported_extra_ops={
