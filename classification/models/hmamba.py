...
from models.utils import MultiScanVSSM
    ...
    def forward_corev2(
        ...
        **kwargs,
        ...
        if cascade2d:
            ...
            xs = self.multiscan.multi_scan(x) #[b k d l,]
            ...
            # print(y.shape,y[0,3,3])
                    
            y = self.multiscan.merge(ys.flatten(-2)) # [B,k,-1,HW] -> [B,D,HW]
            # print(y.shape, y[0,3,3])
            # raise NameError
        ...
        **kwargs,
        ...
        for i_layer in range(self.num_layers):
            ...
            self.layers.append(self._make_layer(
                ...
                gmlp=gmlp,
                deps=range(sum(depths[:i_layer]),sum(depths[:i_layer + 1])),
    ...
    def forward(self, x):
        ...
        if self.pos_embed is not None:
            ...
            if self.pos_embed.shape[-2:] != x.shape[1:-1]:
                ...
                x = x + self.pos_embed.permute(0,2,3,1)
